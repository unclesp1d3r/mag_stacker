...
| [0010](0010-defer-typescript-6-upgrade.md) | Defer the TypeScript 6.0 upgrade; stay on 5.9.x until the Bun type stack resolves under TS 6 | accepted | 2026-07-04 |
| [0011](0011-pin-next-16-2-pending-bun-fix.md) | Pin Next.js to 16.2.11 until Bun stable ships the napi teardown fix | accepted | 2026-08-10 |
