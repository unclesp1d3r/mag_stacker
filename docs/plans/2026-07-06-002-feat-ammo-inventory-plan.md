...
- AS4 (**confirmed 2026-07-07 by owner**). Create-on-behalf is whole-owner trust, not per-parent-type (see KTD7): an existing firearm/magazine create-on-behalf grant also authorizes creating ammo lots for that owner. Confirmed intended — `resolveCreateOwner` stays unscoped.
...
- **create-on-behalf reach** (KTD7/AS4): existing firearm/magazine create-on-behalf grants gain ammo-creation power on ship. Confirmed intended by the owner (2026-07-07); `resolveCreateOwner` stays unscoped.
